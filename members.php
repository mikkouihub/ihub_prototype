        ...
        <div class="mt-bottom-bar">
          <div class="container-fluid">
            <div class="row">
              <div class="col-xs-12">
                <!-- mt logo start here -->
                <div class="mt-logo"><a href="index.php"><img src="images/mt-logo.png" alt="schon"></a></div>
      ...
      <main id="mt-main">
              ...
              <div class="col-xs-12">
                ...
                <div class="holder">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM user, company WHERE user.user_ID = company.company_ID ORDER BY user.user_name LIMIT $start_from, $record_per_page";
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        $owner_image = $row['company_owner_image'];
                        $company_url = $row['company_url'];

                        if ($owner_image != '') {
                          $fileLocation = 'business' . DIRECTORY_SEPARATOR . 'companies' . DIRECTORY_SEPARATOR . $row['company_url'] . DIRECTORY_SEPARATOR . 'profile' . DIRECTORY_SEPARATOR . 'company_owner' . DIRECTORY_SEPARATOR . $row['company_owner_image'];
                        } else {
                          $fileLocation = 'business' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'icons' . DIRECTORY_SEPARATOR . 'default_profile.png';
                        }
                  ...
                  ?>
                        <div class="col wow fadeInLeft" data-wow-delay="0.4s">
                          <div class="img-holder">
                            <a href="business/index-normal.php?company=<?php echo $row['company_url']; ?>">
                              <img src="<?php echo $fileLocation; ?>" alt="CLARA WOODEN">
                          ...
                          <div class="mt-txt">
                            <h4><a href="business/index-normal.php?company=<?php echo $row['company_url']; ?>"><?php echo $row['user_name']; ?></a></h4>
                            <span class="sub-title"><?php echo $row['company_name']; ?></span>
                            <span class="sub-title"><?php echo $row['company_contact_number']; ?></span>
                          </div>
                        </div>
                  <?php
                      }
        ...
        <section class="mt-workspace-sec wow fadeInUp" data-wow-delay="0.4s">
          <div style="text-align: center;">
            <?php
              $sql = "SELECT * FROM user, company WHERE user.user_ID = company.company_ID";
              $stmt = mysqli_stmt_init($conn);
              ...
              if (!mysqli_stmt_prepare($stmt, $sql)) {
                ...
                $total_pages = ceil($records / $record_per_page);

                for ($i = 1; $i <= $total_pages; $i++) { 
                 echo '<h3><a href="members.php?page=' . $i . '">' . $i . '</a></h3>';
                }
              }
            ?>
          </div>
