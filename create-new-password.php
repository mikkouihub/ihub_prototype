              ...
              <div class="col-xs-12 col-sm-10 col-sm-push-1">
                <div class="holder" style="margin: 0;">
                    <div class="mt-side-widget">
                      ...
                      ?>
                            <form action="includes/user-management/generate-new-password.php" method="POST" id="create-new-password-form" style="margin: 0 0 80px;">
                              <fieldset>
                                ...
                                <div class="row2">
                                  <div class="col-xs-12 col-sm-6">
                                    <input type="password" name="confirmPassword" id="confirmPassword" class="input" placeholder="Confirm New Password">
                                    <span class="help-block" id="error"></span>
                                  </div>
                                </div>
                                <div class="box">
                                ...
                                <button type="submit" name="reset-submit" class="btn-type1">Register Me</button>
                              </fieldset>
                            </form>
                      <?php
                          }
