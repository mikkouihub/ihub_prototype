			...
			<div class="mt-side-menu">
				...
				?>
						<div class="mt-holder">
							...
							<div class="mt-side-widget">
								<header>
									<span class="mt-side-subtitle">Welcome back! <?php echo $_SESSION['userEmail']; ?></span>
								</header>
								<form action="includes/user-management/logout.inc.php" method="POST">
									<fieldset>
										<span class="mt-side-subtitle"><a href="business/index-normal2.php">My Profile</a></span>
										<button type="submit" name="logout" class="btn-type1">Logout</button>
									</fieldset>
								</form>
							</div>
						</div>
				...
				?>
						<div class="mt-holder">
							...
							<div class="mt-side-widget">
								...
								<form action="includes/user-management/login.inc.php" id="login-form" method="POST">
									<fieldset>
										<input type="text" placeholder="Email address" name="email" class="input" required>
										<input type="password" placeholder="Password" name="password" class="input" required>
										<div id="info"></div>
										<div class="box">
											<!-- <span class="left"><input class="checkbox" type="checkbox" id="check1"><label for="check1">Remember Me</label></span> -->
											<a href="reset-password.php" class="help">Forgot your password?</a>
										</div>
										<button type="submit" id="btn-login" name="btn-login" class="btn-type1">Login</button>
