<?php
  ...
  require 'includes' . DIRECTORY_SEPARATOR . 'connection' . DIRECTORY_SEPARATOR . 'dbh.inc.php';
?>
              ...
              <div class="col-xs-12 col-sm-10 col-sm-push-1">
                <div class="holder" style="margin: 0;">
                    <div class="mt-side-widget">
                      ...
                      <form action="includes/user-management/sign-up.inc.php" method="POST" id="register-form" style="margin: 0 0 80px;">
                        <fieldset>

                        <!-- ~~~~~~~~~~~~~~~~~~ PLEASE FIX ME ~~~~~~~~~~~~~~~~~~ -->
                        <!-- NOTE: -->
                        <!-- class = 'row1' and 'row2' is not on the CSS -->
                        <!-- each input field must be in DIFFERENT divs' and be in 2 columns. -->
                        <!-- ex. [col1] [col2] -->
                          <div class="row1">
                            <div class="col-xs-12 col-sm-6">
                              <input type="text" placeholder="Full Name" name="fullName" id="fullName" class="input">
                          ...
                          <div class="row2">
                            <div class="col-xs-12 col-sm-6">
                              <input type="password" name="confirmPassword" id="confirmPassword" placeholder="Re-type Password" class="input">
                              <span class="help-block" id="error"></span>
                            </div>
                          </div>
                          <div class="row1">
                            <select name="businessType" id="category-dropdown" class="dropdown-menu" required>
                              <option value="">Select Business Type</option>
                              <?php
                                $sql = "SELECT * FROM company_businesstype";
                              ...
                              ?>
                                    <option value="<?php echo $row['businesstype_id']?>"><?php echo $row['businesstype_name']?></option>
                              <?php
                                  }
                                }
                              ?>
                          ...
                          <div class="row2">
                            <select name="subCategory[]" class="selections" multiple="multiple">
                            <?php
                          ...
                          <div class="row1">
                            <div class="col-xs-12 col-sm-6">
                              <input type="text" placeholder="Company Name" name="companyName" id="companyName" class="input">
                              <span class="help-block" id="error"></span>
                            </div>
                          </div>
                          <div class="row2">
                            <div class="col-xs-12 col-sm-6">
                              <input type="text" placeholder="Company Address"  name="companyAddress" id="companyAddress" class="input">
                              <span class="help-block" id="error"></span>
                            </div>
                          </div>
                          <div class="row1">
                            <div class="col-xs-12 col-sm-6">
                              <input type="text" placeholder="Contact Number" name="contactNo" id="contactNo" class="input">
                              <span class="help-block" id="error"></span>
                            </div>
                          </div>
                          <div class="row2">
                            <div class="col-xs-12 col-sm-6">
                              <input type="text" placeholder="Registration Code" name="code" id="code" class="input">
                              <span class="help-block" id="error"></span>
                            </div>
                          </div>
                          <div class="box">
                          ...
                          <button type="submit" class="btn-type1" name="btn-register" id="btn-register">Register Me</button>
                        </fieldset>
                      </form>
                      <header>
