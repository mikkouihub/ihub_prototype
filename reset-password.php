            ...
            <div class="row">
              <div class="col-xs-12 col-sm-8 col-sm-push-2">
                <div class="holder" style="margin: 0;">
                    <div class="mt-side-widget">
                      <header>
                        <h2 style="margin: 0 0 5px;">RESET PASSWORD</h2>
                        <p>Forgot your password? Reset it now!</p>
                      </header>
                      <form action="includes/user-management/request-reset-password.php" method="POST" id="reset-password-form">
                        <fieldset>
                          <input type="text" placeholder="Email address" name="email" id="email" class="input">
                          <span class="help-block" id="error"></span>
                          <button type="submit" name="reset-btn" class="btn-type1">Reset Password</button>
                        </fieldset>
                      </form>
                    </div>
                </div>
